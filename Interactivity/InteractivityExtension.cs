...
public class InteractivityExtension {
    /// <summary>
    ///     Gets the instance of <see cref="GatewayClient" /> this extension is attached to.
    /// </summary>
    public GatewayClient Client { get; protected set; }
    ...
    protected internal override void Setup(GatewayClient client) {
        this.Client = client;
    ...
    ///     buttons at all.
    /// </exception>
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, IEnumerable<DiscordButtonComponent> buttons, TimeSpan? timeoutOverride = null)
    ...
    ///     buttons at all.
    /// </exception>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, IEnumerable<DiscordButtonComponent> buttons, CancellationToken token) {
    ...
    ///     buttons at all.
    /// </exception>
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, TimeSpan? timeoutOverride = null)
    ...
    ///     buttons at all.
    /// </exception>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, CancellationToken token) {
        if (message.Author != this.Client.CurrentUser)
            throw new InvalidOperationException("Interaction events are only sent to the application that created them.");
    ...
    ///     buttons at all.
    /// </exception>
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, User user, TimeSpan? timeoutOverride = null)
    ...
    ///     buttons at all.
    /// </exception>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, User user, CancellationToken token) {
        if (message.Author != this.Client.CurrentUser)
            throw new InvalidOperationException("Interaction events are only sent to the application that created them.");
    ...
    ///     buttons at all.
    /// </exception>
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, string id, TimeSpan? timeoutOverride = null)
    ...
    ///     buttons at all.
    /// </exception>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, string id, CancellationToken token) {
        if (message.Author != this.Client.CurrentUser)
            throw new InvalidOperationException("Interaction events are only sent to the application that created them.");
    ...
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, TimeSpan? timeoutOverride = null)
    ...
    ///     wait indefinitely.
    /// </param>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, CancellationToken token) {
        if (message.Author != this.Client.CurrentUser)
            throw new InvalidOperationException("Interaction events are only sent to the application that created them.");
    ...
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, ComponentType selectType, TimeSpan? timeoutOverride = null)
    ...
    /// </param>
    /// <exception cref="ArgumentException">Thrown when the Provided message does not contain any dropdowns</exception>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, ComponentType selectType, CancellationToken token) {
        if (message.Author != this.Client.CurrentUser)
            throw new InvalidOperationException("Interaction events are only sent to the application that created them.");
    ...
    ///     specified Id.
    /// </exception>
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(RestMessage message, string id, ComponentType selectType, TimeSpan? timeoutOverride = null)
    ...
    ///     specified Id.
    /// </exception>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(RestMessage message, string id, ComponentType selectType, CancellationToken token) {
        if (message.Author != this.Client.CurrentUser)
            throw new InvalidOperationException("Interaction events are only sent to the application that created them.");
    ...
    ///     specified Id.
    /// </exception>
    public Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(RestMessage message, User user, string id, ComponentType selectType, TimeSpan? timeoutOverride = null)
    ...
    ///     specified Id.
    /// </exception>
    public async Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(RestMessage message, User user, string id, ComponentType selectType, CancellationToken token) {
        if (message.Author != this.Client.CurrentUser)
            throw new InvalidOperationException("Interaction events are only sent to the application that created them.");
    ...
    public async Task<InteractivityResult<RestMessage>> WaitForMessageAsync(
        Func<RestMessage, bool> predicate,
    ...
    /// <param name="user">User that starts typing.</param>
    /// <param name="timeoutOverride">Override timeout period.</param>
    public async Task<InteractivityResult<TypingStartEventArgs>> WaitForUserTypingAsync(User user, TimeSpan? timeoutOverride = null) {
        if (!Utilities.HasTypingIntents(this.Client.Configuration.Intents))
            throw new InvalidOperationException("No typing intents are enabled.");
    ...
    /// <param name="timeoutOverride">Override timeout period.</param>
    public async Task<ReadOnlyCollection<Reaction>> CollectReactionsAsync(RestMessage m, TimeSpan? timeoutOverride = null) {
        if (!Utilities.HasReactionIntents(this.Client.Configuration.Intents))
            throw new InvalidOperationException("No reaction intents are enabled.");
    ...
    public async Task SendPaginatedMessageAsync(
        ...
        var builder = new RestMessageBuilder()
    ...
    /// <param name="deletion">Deletion behaviour.</param>
    /// <param name="token">A custom cancellation token that can be cancelled at any point.</param>
    public async Task SendPaginatedResponseAsync(DiscordInteraction interaction, bool deferred, bool ephemeral, User user, IEnumerable<Page> pages, PaginationButtons? buttons = null, PaginationBehaviour? behaviour = default,
        ButtonPaginationBehavior? deletion = default, CancellationToken token = default) {
        var bhv = behaviour ?? this.Config.PaginationBehaviour;
        var del = deletion ?? this.Config.ButtonBehavior;
        var bts = buttons ?? this.Config.PaginationButtons;
