...
{
	private readonly RestMessageBuilder _builder = new();
	...
	public ComponentPaginator(GatewayClient client, InteractivityConfiguration config)
	{
		this._client = client;
	...
	private async Task Handle(GatewayClient _, ComponentInteractionCreateEventArgs e)
	{
