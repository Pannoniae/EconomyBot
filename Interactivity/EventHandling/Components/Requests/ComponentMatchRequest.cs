...
internal class ComponentMatchRequest
{
	...
	public ComponentMatchRequest(RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, CancellationToken cancellation)
	{
	...
	/// </summary>
	public RestMessage Message { get; private set; }
