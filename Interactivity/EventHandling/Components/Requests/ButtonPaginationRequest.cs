...
internal class ButtonPaginationRequest : IPaginationRequest
{
	...
	private readonly RestMessage _message;
	...
	///     Gets the message.
	/// </summary>
	public Task<RestMessage> GetMessageAsync() => Task.FromResult(this._message);

	/// <summary>
	///     Gets the user.
	/// </summary>
	public Task<User> GetUserAsync() => Task.FromResult(this._user);
	...
	public async Task DoCleanupAsync()
	{
		switch (this._behaviorBehavior)
		{
			...
			case ButtonPaginationBehavior.DeleteButtons:
				builder = new RestMessageBuilder()
					.WithContent(this._pages[this._index].Content)
					.AddEmbed(this._pages[this._index].Embed);
