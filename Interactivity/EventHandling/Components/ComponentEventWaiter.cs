...
internal class ComponentEventWaiter : IDisposable
{
	...
	public ComponentEventWaiter(GatewayClient client, InteractivityConfiguration config)
	{
		this._client = client;
	...
	private async Task Handle(GatewayClient _, ComponentInteractionCreateEventArgs args)
	{
