...
/// <summary>
///     Interactivity extension methods for <see cref="RestMessage" />.
/// </summary>
public static class MessageExtensions
{
	...
	public static Task<InteractivityResult<RestMessage>> GetNextMessageAsync(this RestMessage message, TimeSpan? timeoutOverride = null)
	...
	/// <param name="timeoutOverride">Overrides the timeout set in <see cref="InteractivityConfiguration.Timeout" /></param>
	public static Task<InteractivityResult<RestMessage>> GetNextMessageAsync(this RestMessage message, Func<RestMessage, bool> predicate, TimeSpan? timeoutOverride = null)
	...
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message)
	...
	/// <param name="message">The message to wait on.</param>
	/// <param name="timeoutOverride">Overrides the timeout set in <see cref="InteractivityConfiguration.Timeout" /></param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, TimeSpan? timeoutOverride = null)
	...
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, CancellationToken token)
	...
	/// <param name="timeoutOverride">Overrides the timeout set in <see cref="InteractivityConfiguration.Timeout" /></param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, string id, TimeSpan? timeoutOverride = null)
	...
	/// <param name="id">The Id of the button to wait for.</param>
	/// <param name="token">A custom cancellation token that can be cancelled at any point.</param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, string id, CancellationToken token)
	...
	/// <param name="timeoutOverride">Overrides the timeout set in <see cref="InteractivityConfiguration.Timeout" /></param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, User user, TimeSpan? timeoutOverride = null)
	...
	/// <param name="user">The user to wait for button input from.</param>
	/// <param name="token">A custom cancellation token that can be cancelled at any point.</param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, User user, CancellationToken token)
	...
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, TimeSpan? timeoutOverride = null)
	...
	///     wait indefinitely.
	/// </param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForButtonAsync(this RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, CancellationToken token)
	...
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(this RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, ComponentType selectType, TimeSpan? timeoutOverride = null)
	...
	/// </param>
	/// <exception cref="ArgumentException">Thrown when the message doesn't contain any dropdowns</exception>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(this RestMessage message, Func<ComponentInteractionCreateEventArgs, bool> predicate, ComponentType selectType, CancellationToken token)
	...
	/// <param name="selectType">The <see cref="ComponentType">type</see> of the select menu.</param>
	/// <param name="timeoutOverride">Overrides the timeout set in <see cref="InteractivityConfiguration.Timeout" /></param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(this RestMessage message, string id, ComponentType selectType, TimeSpan? timeoutOverride = null)
	...
	/// <param name="selectType">The <see cref="ComponentType">type</see> of the select menu.</param>
	/// <param name="token">A custom cancellation token that can be cancelled at any point.</param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(this RestMessage message, string id, ComponentType selectType, CancellationToken token)
	...
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(this RestMessage message, User user, string id, ComponentType selectType, TimeSpan? timeoutOverride = null)
	...
	/// <param name="selectType">The <see cref="ComponentType">type</see> of the select menu.</param>
	/// <param name="token">A custom cancellation token that can be cancelled at any point.</param>
	public static Task<InteractivityResult<ComponentInteractionCreateEventArgs>> WaitForSelectAsync(this RestMessage message, User user, string id, ComponentType selectType, CancellationToken token)
	...
	///     message.
	/// </exception>
	public static Task<InteractivityResult<MessageReactionAddEventArgs>> WaitForReactionAsync(this RestMessage message, User user, TimeSpan? timeoutOverride = null)
	...
	///     message.
	/// </exception>
	public static Task<ReadOnlyCollection<Reaction>> CollectReactionsAsync(this RestMessage message, TimeSpan? timeoutOverride = null)
	...
	/// </summary>
	internal static InteractivityExtension GetInteractivity(RestMessage message)
	{
		var client = (GatewayClient)message.Discord;
