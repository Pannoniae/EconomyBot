...
/// <summary>
///     Interactivity extension methods for <see cref="GatewayClient" /> and <see cref="DiscordShardedClient" />.
/// </summary>
public static class ClientExtensions
{
	/// <summary>
	///     Enables interactivity for this <see cref="GatewayClient" /> instance.
	/// </summary>
	...
	public static InteractivityExtension UseInteractivity(this GatewayClient client, InteractivityConfiguration configuration = null)
	{
	...
	///     enabled for the <see cref="GatewayClient" /> instance.
	/// </returns>
	public static InteractivityExtension GetInteractivity(this GatewayClient client)
